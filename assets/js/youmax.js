    ...
    (function ($) {
        ...
        showPlaylists = function(response,loadMoreFlag) {
            ...
            for(var i=0; i<playlistArray.length; i++) {
                ...
                $('#youmax-video-list-div').append('<div class="youmax-video-tnail-box" id="'+playListId+'"><div class="youmax-video-tnail" style="filter: progid:DXImageTransform.Microsoft.AlphaImageLoader( src=\''+playlistThumbnail+'\', sizingMethod=\'scale\'); background-image:url(\''+playlistThumbnail+'\')"><div class="youmax-playlist-sidebar" id="youmax-playlist-sidebar-'+playListId+'"><span class="youmax-playlist-video-count"><b>'+playlistSize+'</b><br/>VIDEOS</span></div></div><span class="youmax-video-list-title">'+playlistTitle+'</span><br/><span class="youmax-video-list-views">'+getDateDiff(playlistUploaded)+' назад</span></div>');
        ...
        displayVideoStats = function(response) {
            ...
            for(var i=0; i<videoArray.length; i++) {
                ...
                $videoThumbnail.find('.youmax-video-list-views').prepend(videoViewCount+' просмотров | ');
